<!-- Modal -->
<div class="modal fade" id="LettersCreate" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-content rounded-0">
            <form action="{{ route('podesavanja.store') }}" method="POST">
                ...
                <div class="modal-header">
                    <h1 class="modal-title fs-5">Novi Žanr</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                @include('settings.letters.form')
