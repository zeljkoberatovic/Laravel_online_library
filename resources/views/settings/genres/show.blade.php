...
<div class="main-content">
        ...
        <div class="col pt-0 pb-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb j-breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Žanrovi</li>
                </ol>
            </nav>
            <h2>Žanr</h2>
        </div>
    ...
    <div class="py-3 mb-3 w-100 d-flex justify-content-center">
        ...
        <a href = "{{ route('podesavanja.edit', [$data->id]) }}?option=genres" class="btn btn-primary rounded-0 w-25 rounded-end-pill">Izmijeni</a>
    </div>
